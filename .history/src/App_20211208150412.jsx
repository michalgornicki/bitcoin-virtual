...
function App() {
  ...
  return (
    <div className="wrapper">
      ...
      <div className="price">
        <img className="icon" src={Ethereum} alt=""/>
        1 BTC = {ethereumPrice}{" "} PLN
        <div className="percent" style={{ color: ethereumPrice > 300 ? 'rgb(9, 255, 0)' : 'rgb(255, 39, 39)' }}> {percentValueEth()} </div>
      </div>
