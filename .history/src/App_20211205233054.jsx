  ...
  return (
    <div className="wrapper">
      ...
      <div className="button-container w-50 m-auto">
        <Button className="primary m-1 btn-lg " onClick={buyBitcoin}>
          Buy BTC for 1000 PLN
        </Button>
        <Button className="outline-primary m-1 btn-lg " onClick={buyMAXBitcoin}>
          Buy BTC for MAX PLN
        </Button>
        <Button className="success m-1 btn-lg " onClick={sellBitcoin}>
          Sell 0.1 BTC
        </Button>
        <Button className="outline-success m-1 btn-lg " onClick={sellMAXBitcoin}>
          Sell MAX BTC
        </Button>
      </div>
    </div>
