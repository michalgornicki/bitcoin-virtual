...
const buyBitcoin = () => {
  ...
  setAccountBTC(accountBTC => parseFloat((accountBTC + 1000/bitcoinPrice).toFixed(3)));
  console.log(accountBTC);
}

const sellBitcoin = () => {
  setAccountPLN(accountPLN + bitcoinPrice/10);
  setAccountBTC(accountBTC => parseFloat((accountBTC - 0.1).toFixed(3)));
  console.log(accountBTC);
}
...
[]);
  ...
  return (
    <p>
      ...
      <div className="button" onClick={buyBitcoin}></div>
      <div className="button" onClick={sellBitcoin}></div>
    </p>
  );
}
