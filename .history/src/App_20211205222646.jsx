  ...
  return (
    <p>
      ...
      <div className="button-container w-50 m-auto">
        <Button variant="warning m-1 btn-lg w-50" onClick={buyBitcoin}>
          Buy BTC for 1000 PLN
        </Button>
        <Button variant="warning m-1 btn-lg w-50" onClick={buyMAXBitcoin}>
          Buy BTC for MAX PLN
        </Button>
        <Button className="success m-1 btn-lg w-50" onClick={sellBitcoin}>
          Sell 0.1 BTC
        </Button>
        <Button className="success m-1 btn-lg w-50" onClick={sellMAXBitcoin}>
          Sell MAX BTC
        </Button>
      </div>
    </p>
