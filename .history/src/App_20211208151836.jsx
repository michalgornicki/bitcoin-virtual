  ...
  return (
    <div className="wrapper">
      ...
      <div className="button-container">
        ...
        <Button variant="primary m-1 btn-lg w-25" onClick={buyBitcoin}>
          Buy BTC for 1000 PLN
        </Button>
        <Button variant="primary m-1 btn-lg  w-25" onClick={buyMAXBitcoin}>
        Buy BTC for MAX PLN
        </Button>
        <Button variant="secondary m-1 btn-lg  w-25" onClick={sellBitcoin}>
          Sell 0.1 BTC
        </Button>
        <Button variant="secondary m-1 btn-lg  w-25" onClick={sellMAXBitcoin}>
          Sell MAX BTC
        </Button>
        </div>
        <div className="button-container-inner">

        <Button variant="primary m-1 btn-lg w-25 " onClick={buyEthereum}>
          Buy ETH for 1000 PLN
        </Button>
        <Button variant="primary m-1 btn-lg w-25 " onClick={buyMAXEthereum}>
          Buy ETH for MAX PLN
        </Button>
        <Button variant="secondary m-1 btn-lg w-25 " onClick={sellEthereum}>
          Sell 0.1 ETH
        </Button>
        <Button variant="secondary m-1 btn-lg w-25 " onClick={sellMAXEthereum}>
          Sell MAX ETH
        </Button>
        </div>
