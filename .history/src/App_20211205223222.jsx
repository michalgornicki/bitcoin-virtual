  ...
  return (
    <p>
      ...
      <div className="button-container w-50 m-auto">
        <Button variant="outline-primary m-1 btn-lg w-50" onClick={buyBitcoin}>
          Buy BTC for 1000 PLN
        </Button>
        <Button variant="outline-secondary m-1 btn-lg w-50" onClick={buyMAXBitcoin}>
          Buy BTC for MAX PLN
        </Button>
        <Button variant="outline-success m-1 btn-lg w-50" onClick={sellBitcoin}>
          Sell 0.1 BTC
        </Button>
        <Button variant="outline-danger m-1 btn-lg w-50" onClick={sellMAXBitcoin}>
          Sell MAX BTC
        </Button>
      </div>
    </p>
