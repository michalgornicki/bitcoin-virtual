...
function App() {
  ...
  const percent = () => {
    const percentChange = parseFloat((((bitcoinPrice - 5000) / bitcoinPrice) * 100).toFixed(2));

    if (percentChange > 0) {document.getElementsByClassName("percent")[0].style.color="red";}
    else {document.getElementsByClassName("percent")[0].style.color="green";}
  ...
  return (
    <div className="wrapper">
      ...
      <div className="price">
        ...
        <div className="percent"> {percentValue()} </div>
      </div>
