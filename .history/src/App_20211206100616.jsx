...
function App() {
  ...
  const percent = () => parseFloat(((bitcoinPrice - 5000)/bitcoinPrice*100).toFixed(2))

  const percentValue = () =>  "(" + parseFloat(((bitcoinPrice - 5000)/bitcoinPrice*100).toFixed(2)) + "%)"; 
  ...
  return (
    ...
    <div className="wrapper">
      <div className="price">1 BTC = {bitcoinPrice} <div className="percent"> PLN {percentValue()} </div></div>
