  ...
  return (
    <p>
      ...
      <div className="button-container w-50 m-auto">
        <Button type="primary m-1 btn-lg w-50" onClick={buyBitcoin}>
          Buy BTC for 1000 PLN
        </Button>
        <Button type="btn-outline-warning m-1 btn-lg w-50" onClick={buyMAXBitcoin}>
          Buy BTC for MAX PLN
        </Button>
        <Button type="success m-1 btn-lg w-50" onClick={sellBitcoin}>
          Sell 0.1 BTC
        </Button>
        <Button type="danger m-1 btn-lg w-50" onClick={sellMAXBitcoin}>
          Sell MAX BTC
        </Button>
      </div>
    </p>
