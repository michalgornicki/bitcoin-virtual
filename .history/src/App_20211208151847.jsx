  ...
  return (
    <div className="wrapper">
      ...
      <div className="button-container">
        ...
        <Button variant="primary m-1 btn-md w-25 " onClick={buyMAXEthereum}>
          Buy ETH for MAX PLN
        </Button>
        <Button variant="secondary m-1 btn-md w-25 " onClick={sellEthereum}>
          Sell 0.1 ETH
        </Button>
        <Button variant="secondary m-1 btn-md w-25 " onClick={sellMAXEthereum}>
          Sell MAX ETH
        </Button>
        </div>
